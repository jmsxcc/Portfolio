        ...
        <div className="about_data grid">
          <div className="about_info">
            <p className="about_description">
              First-class honors graduate in computer and robotic engineering, specializing in HTML, CSS, JavaScript, Python, and C. Experienced in developing web applications as an consultant for SCG, enhancing document management, inventory, and logistics systems. Skilled in problem-solving, critical thinking, and time management. Seeking a career as a Full-Stack Developer or Frontend Developer.
            </p>
